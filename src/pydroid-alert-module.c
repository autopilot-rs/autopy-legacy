#include "pydroid-alert-module.h"
#include "alert.h"

/* Syntax: alert(msg, title="Pydroid Alert", default_button="OK",
                 [cancel_button]) */
...
static PyMethodDef AlertMethods[] = {
	{"alert", (PyCFunction)alert_alert, METH_VARARGS | METH_KEYWORDS,
	 "alert(msg, title='Pydroid Alert', default_button='OK', "
...
PyMODINIT_FUNC initalert(void)
{
	Py_InitModule3("alert", AlertMethods,
	               "pydroid module for displaying alerts");
}

static PyObject *alert_alert(PyObject *self, PyObject *args, PyObject *kwds)
{
	char *msg = NULL, *title = "Pydroid Alert";
